...
AVRDUDE_WRITE_FUSES = -U lfuse:w:$(TARGET).elf -U hfuse:w:$(TARGET).elf -U efuse:w:$(TARGET).elf
...
program: $(TARGET).hex $(TARGET).eep
	$(AVRDUDE) $(AVRDUDE_FLAGS) $(AVRDUDE_WRITE_FLASH) $(AVRDUDE_WRITE_FUSES) $(AVRDUDE_WRITE_EEPROM)
